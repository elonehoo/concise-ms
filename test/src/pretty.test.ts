...
test('`colonNotation` option',()=>{
  expect(prettyMilliseconds(1000, {colonNotation: true})).toBe('0:01')
  expect(prettyMilliseconds(1543, {colonNotation: true})).toBe('0:01.5')
  expect(prettyMilliseconds(1000 * 60, {colonNotation: true})).toBe('1:00')
  expect(prettyMilliseconds(1000 * 90, {colonNotation: true})).toBe('1:30')
  expect(prettyMilliseconds(95_543, {colonNotation: true})).toBe('1:35.5')
  expect(prettyMilliseconds((1000 * 60 * 10) + 543, {colonNotation: true})).toBe('10:00.5')
  expect(prettyMilliseconds((1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true})).toBe('59:59.5')
  expect(prettyMilliseconds((1000 * 60 * 60 * 15) + (1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true})).toBe('15:59:59.5')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 0})).toBe('0:00')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 1})).toBe('0:00.9')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 2})).toBe('0:00.99')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 3})).toBe('0:00.999')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 0})).toBe('0:01')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 1})).toBe('0:01')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 2})).toBe('0:01')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 3})).toBe('0:01')
  expect(prettyMilliseconds(1001, {colonNotation: true, secondsDecimalDigits: 0})).toBe('0:01')
  expect(prettyMilliseconds(1001, {colonNotation: true, secondsDecimalDigits: 1})).toBe('0:01')
  expect(prettyMilliseconds(1001, {colonNotation: true, secondsDecimalDigits: 2})).toBe('0:01')
  expect(prettyMilliseconds(1001, {colonNotation: true, secondsDecimalDigits: 3})).toBe('0:01.001')
  expect(prettyMilliseconds(1543, {colonNotation: true, secondsDecimalDigits: 0})).toBe('0:01')
  expect(prettyMilliseconds(1543, {colonNotation: true, secondsDecimalDigits: 1})).toBe('0:01.5')
  expect(prettyMilliseconds(1543, {colonNotation: true, secondsDecimalDigits: 2})).toBe('0:01.54')
  expect(prettyMilliseconds(1543, {colonNotation: true, secondsDecimalDigits: 3})).toBe('0:01.543')
  expect(prettyMilliseconds(95_543, {colonNotation: true, secondsDecimalDigits: 0})).toBe('1:35')
  expect(prettyMilliseconds(95_543, {colonNotation: true, secondsDecimalDigits: 1})).toBe('1:35.5')
  expect(prettyMilliseconds(95_543, {colonNotation: true, secondsDecimalDigits: 2})).toBe('1:35.54')
  expect(prettyMilliseconds(95_543, {colonNotation: true, secondsDecimalDigits: 3})).toBe('1:35.543')
  expect(prettyMilliseconds((1000 * 60 * 10) + 543, {colonNotation: true, secondsDecimalDigits: 3})).toBe('10:00.543')
  expect(prettyMilliseconds((1000 * 60 * 60 * 15) + (1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true, secondsDecimalDigits: 3})).toBe('15:59:59.543')

  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 0, keepDecimalsOnWholeSeconds: true})).toBe('0:00')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 1, keepDecimalsOnWholeSeconds: true})).toBe('0:00.9')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 2, keepDecimalsOnWholeSeconds: true})).toBe('0:00.99')
  expect(prettyMilliseconds(999, {colonNotation: true, secondsDecimalDigits: 3, keepDecimalsOnWholeSeconds: true})).toBe('0:00.999')

  expect(prettyMilliseconds(1000, {colonNotation: true, keepDecimalsOnWholeSeconds: true})).toBe('0:01.0')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 0, keepDecimalsOnWholeSeconds: true})).toBe('0:01')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 1, keepDecimalsOnWholeSeconds: true})).toBe('0:01.0')
  expect(prettyMilliseconds(1000, {colonNotation: true, secondsDecimalDigits: 3, keepDecimalsOnWholeSeconds: true})).toBe('0:01.000')

  expect(prettyMilliseconds(1000 * 90, {colonNotation: true, secondsDecimalDigits: 0, unitCount: 1})).toBe('1')
  expect(prettyMilliseconds(1000 * 90, {colonNotation: true, secondsDecimalDigits: 0, unitCount: 2})).toBe('1:30')
  expect(prettyMilliseconds(1000 * 60 * 90, {colonNotation: true, secondsDecimalDigits: 0, unitCount: 3})).toBe('1:30:00')

  expect(prettyMilliseconds(95_543, {colonNotation: true, secondsDecimalDigits: 1, unitCount: 1})).toBe('1')
  expect(prettyMilliseconds(95_543, {colonNotation: true, secondsDecimalDigits: 1, unitCount: 2})).toBe('1:35.5')
  expect(prettyMilliseconds(95_543 + (1000 * 60 * 60), {colonNotation: true, secondsDecimalDigits: 1, unitCount: 3})).toBe('1:01:35.5')

  expect(prettyMilliseconds((1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true, formatSubMilliseconds: true})).toBe('59:59.5')
  expect(prettyMilliseconds((1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true, separateMilliseconds: true})).toBe('59:59.5')
  expect(prettyMilliseconds((1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true, verbose: true})).toBe('59:59.5')
  expect(prettyMilliseconds((1000 * 60 * 59) + (1000 * 59) + 543, {colonNotation: true, compact: true})).toBe('59:59.5')
})
